...
extern SrlStatus spiReadPromByte(const tSpiParameters *parms,
                                           uint32_t address,
                                            uint8_t *data);
extern SrlStatus spiPromDump(const tSpiParameters *parms,
                                       uint32_t offset,
                                tFlashDeviceId flashDevice);
extern SrlStatus spiReadId(const tSpiParameters *parms, tFlashDeviceId *pDeviceId);
extern SrlStatus spiProgramProm(const tSpiParameters *parms,
                                           uint8_t *bitfile,
                                          uint32_t fileSize,
                                          uint32_t location,
