        ...
        if fvp is not None:
            ...
            if 'admin_status' in fvp:
                if 'index' in fvp:
                    ...
                    if port_index in range(1, 17) or port_index in range(33, 35):
                        file_name = SWPLD2_DIR + f"port_{port_index}_led"
                    elif port_index in range(17, 33):
                        file_name = SWPLD3_DIR + f"port_{port_index}_led"
                    else:
                ...
                if fvp['admin_status'] == 'up':
                    if port_index in range(33, PORT_NUM+1):
