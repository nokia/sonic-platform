...
class Thermal(ThermalBase):
    ...
    I2C_DEV_LIST = ["20-0048", "16-004b", "16-0049", "16-004a", "16-004e",
                    "16-004f", "17-004e", "17-004f"]
    THERMAL_NAME = ["CPU Board", "MAC Left", "MAC Right", "MB Right", "MB MAC",
                    "MB Left", "Fan Right", "Fan Left", "ASIC TH5", "CPU"]
    THRESHHOLD = [72.0, 60.0, 60.0, 58.0, 82.0, 63.0, 59.0, 60.0, 92.0, 95.0]
    CRITICAL_THRESHHOLD = [75.0, 63.0, 63.0, 61.0, 85.0, 66.0, 62.0, 63.0, 95.0, 100.0]

    def __init__(self, thermal_index):
        ThermalBase.__init__(self)
        self.index = thermal_index + 1
        if self.index == 7 or self.index == 8:
