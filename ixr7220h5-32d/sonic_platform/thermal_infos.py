...
class ThermalInfo(ThermalPolicyInfoBase):
    ...
    def __init__(self):
        ...
        self._level_up_threshold = [[63, 51, 39, 48, 72, 40, 48, 46, 81, 87],
                                    [66, 53, 42, 51, 75, 42, 51, 48, 83, 90],
                                    [69, 56, 45, 54, 78, 45, 54, 51, 85, 93]]

        self._level_down_threshold = [[60, 48, 35, 44, 69, 36, 45, 43, 79, 85],
                                      [62, 50, 38, 47, 71, 39, 47, 45, 80, 86],
                                      [65, 52, 41, 50, 74, 41, 50, 47, 82, 89]]
