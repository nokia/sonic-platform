"""
    ...
    for Nokia IXR 7220 H5-32D platform.
...
class Sfp(SfpOptoeBase):
    """
    Nokia IXR-7220 H5-32D Platform-specific Sfp refactor class
    """
    instances = []
    ...
    def __init__(self, index, sfp_type, eeprom_path, port_i2c_map):
        ...
        if self.index >= 17 and self.index <= 32:
        ...
        #sonic_logger.log_info(f"sfp.py __init__ index {index} setting name to {self.name} and eeprom_path to {eeprom_path}")
