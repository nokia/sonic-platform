...
class Thermal(ThermalBase):
    ...
    I2C_DEV_LIST = ["6-004f", "6-004b", "6-004a", "6-004e", "6-0049", 
                    "5-0049", "6-0048", "7-004f", "7-004e"]
    THERMAL_NAME = ["MB Left", 
                    "MB Front", 
                    "MB Right", 
                    "MB MAC", 
                    "PSU top", 
    ...
    def __init__(self, thermal_index):
        ...
        if self.index == H5_64D_THERMAL:    # MAC internal sensor
