...
class ThermalInfo(ThermalPolicyInfoBase):
    ...
    def __init__(self):
        ...
        self._level_up_threshold = [[63, 51, 39, 48, 83, 40, 48, 46, 39, 92, 87],
                                    [66, 53, 42, 51, 86, 42, 51, 48, 41, 95, 90],
                                    [69, 56, 45, 54, 89, 45, 54, 51, 44, 98, 93]]
        
        self._level_down_threshold = [[60, 48, 33, 44, 69, 34, 45, 43, 33, 79, 85],
                                      [62, 50, 36, 47, 71, 37, 47, 45, 36, 80, 86],
                                      [65, 52, 39, 50, 74, 39, 50, 47, 38, 82, 89]]
