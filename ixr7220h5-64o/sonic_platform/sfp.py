"""
    ...
    for Nokia IXR 7220 H5-64O platform.
...
class Sfp(SfpOptoeBase):
    """
    Nokia IXR-7220 H5-64O Platform-specific Sfp refactor class
    """
    instances = []
    ...
    def reset(self):
        ...
        if self.index <= PORT_NUM:
            ...
            result2 = write_sysfs_file(self.swpld_path+f"port_{self.index}_lpmod", '0')
