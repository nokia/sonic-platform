...
class ThermalInfo(ThermalPolicyInfoBase):
    ...
    def __init__(self):
        ...
        self._level_up_threshold = [[56, 58, 39, 51, 66, 45, 48, 47, 38, 77, 84],
                                    [58, 60, 44, 54, 68, 48, 52, 51, 44, 80, 88],
                                    [60, 62, 47, 56, 70, 51, 56, 54, 47, 82, 90]]

        self._level_down_threshold = [[50, 50, 33, 44, 58, 39, 42, 41, 33, 73, 80],
                                      [52, 54, 40, 47, 60, 42, 47, 46, 40, 74, 81],
                                      [54, 56, 42, 49, 62, 44, 50, 48, 42, 75, 83]]
