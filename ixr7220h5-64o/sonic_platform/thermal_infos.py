...
class ThermalInfo(ThermalPolicyInfoBase):
    ...
    def __init__(self):
        ...
        self._level_up_threshold = [[63, 66, 41, 54, 83, 48, 51, 50, 40, 92, 87],
                                    [66, 68, 43, 57, 86, 50, 54, 53, 43, 95, 90],
                                    [69, 70, 45, 59, 89, 52, 56, 55, 45, 98, 93]]

        self._level_down_threshold = [[57, 52, 34, 45, 69, 40, 44, 43, 34, 79, 80],
                                      [60, 58, 39, 49, 71, 44, 49, 48, 39, 80, 83],
                                      [63, 60, 40, 51, 74, 45, 50, 49, 40, 82, 86]]
