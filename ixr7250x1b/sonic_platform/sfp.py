"""
    ...
    for NOKIA 7250 IXR-X1B platform.
...
class Sfp(SfpOptoeBase):
    ...
    def __init__(self, index, sfp_type, eeprom_path, port_i2c_map):
        ...
        if index < QSFPDD_PORT_START:
            ...
            self.name = sfp_type + '_' + str(index-QSFPDD_PORT_START+1)
            self.port_name = sfp_type + '_' + str(index-QSFPDD_PORT_START)
